  ...
  include('chemistry_navigation.php');
$k=1;
?>

<div class="row" >   
    <div class="col-lg-12" style="text-align:center;margin-top:0px ;color:#0E8AE8;">    
        <h2 style='margin-bottom:-2%;'><b>Department of Applied Chemistry</b></h2>     
    </div>        </div>
